...
class TestApp(EWrapper, EClient):
    ...
    def execDetails(self, reqId: int, contract: Contract, execution: Execution):
        ...
        print("ExecDetails. ReqId:", reqId, "Symbol:", contract.symbol, "SecType:", contract.secType, "Currency:", contract.currency, "PermId:", execution)
...
#        execFilter.time = "20240526-02:30:00" 
#        execFilter.secType = "Bag"
...
def main():
    try:
        app = TestApp()
        app.connect('192.168.43.222', 7496, clientId=999)
